...
const Buytrade = ({ onBuyClick, onTabChange, sharePrice, balance, buySuccess}) => { 
            ...
            <div className="trade-content">
                <div className="share-content">
                    ...
                    <input 
                        ...
                        type="text"
                        placeholder="Enter a share amount to buy" 
                        value={shares}
                ...
                <div className="transaction">
                    <p className="text-avail">${balance} available</p>
                    <button className="button-stretch" onClick={onBuyClick}>Buy</button>
                </div>
            </div>
        </div>
    );
